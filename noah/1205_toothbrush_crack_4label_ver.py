...
class ToothBrushCrackDataset(utils.Dataset):
    ...
    def load_toothbrush_crack(self, dataset_dir, subset):
...
def train(model):
    ...
    dataset_train.load_toothbrush_crack(args.dataset, "train")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = ToothBrushCrackDataset()
    dataset_val.load_toothbrush_crack(args.dataset, "val")
    dataset_val.prepare()
