...
class ToothBrushHeadDataset(utils.Dataset):

    def load_toothbrush_head(self, dataset_dir, subset):
        """Load a subset of the Balloon dataset.
        dataset_dir: Root directory of the dataset.
        subset: Subset to load: train or val
        """
        # Add classes. We have only one class to add.
        self.add_class("toothbrush_head", 1, "toothbrush_head")
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        if image_info["source"] != "toothbrush_head":
    ...
    def image_reference(self, image_id):
        ...
        info = self.image_info[image_id]
        if info["source"] == "toothbrush_head":
            return info["path"]
        else:
...
def train(model):
    """Train the model."""
    # Training dataset.
    dataset_train = ToothBrushHeadDataset()
    dataset_train.load_toothbrush_head(args.dataset, "train")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = ToothBrushHeadDataset()
    dataset_val.load_toothbrush_head(args.dataset, "val")
    dataset_val.prepare()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', required=False,
                        ...
                        default='./',
                        help='Directory of the Balloon dataset (for training)')
    parser.add_argument('--weights', required=False,
                        metavar="/path/to/weights.h5",
                        default='coco',  # './mask_rcnn_toothbrush_head_0015.h5',
    ...
    parser.add_argument('--image', required=False,
                        ...
                        default='./test/',
                        help='Image to apply the color splash effect on (for testing)')
