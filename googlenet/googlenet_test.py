...
test_img = "/home/ivpl-d14/PycharmProjects/imagenet/imagenet/test_4classes/african_chameleon2.JPEG"
...
print('data category : ', todict[result[0]])
print('data category result : ', result)
